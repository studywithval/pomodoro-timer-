...
- **Dopamine-friendly rewards** — finishing a focus session triggers a little cat celebration (jump + sparkles + a soft chime), and the app tracks a daily streak and session count so progress is visible.
...
- HTML5 + CSS3 (flexbox, SVG ring + cat animation)
